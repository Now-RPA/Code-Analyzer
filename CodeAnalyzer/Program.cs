    ...
    public static class Program
    {
        ...
        private static Option<String> CreateInputOption()
        {
            var option = new Option<String>(
                name: "--input",
                description: "The input .iBot file to analyze.")
            {
                IsRequired = true
            };
            option.AddAlias("-i");
        ...
        private static Option<String> CreateOutputOption()
        {
            var option = new Option<string>(
                name: "--output",
                description: "The output CSV file path. If not specified, it will be created in the same directory as the input file.");
            option.AddAlias("-o");
            return option;
        }
        ...
        private static Task<int> HandleCommandLineAnalysis(String inputPath, String? outputPath)
        {
            try
            {
                ...
                ConsoleOutputHandler.DisplayEscapedInfo($"💾 Analysis report saved:[blue]{Markup.Escape(reportFilePath)}[/]");
